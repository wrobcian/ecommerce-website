    ...
    try {
      ...
      if($polaczenie->connect_errno!=0) {
        ...
        if ($wszystko_ok==true) { 
          ...
          if($polaczenie->query("UPDATE uzytkownicy SET nazwa='$nick',haslo='$haslo_hash',email='$email',NrDomu='$NrDomu',Miejscowosc='$Miejscowosc',KodPocztowy='$KodPocztowy' WHERE uzytkownicy_id = $id")) {
                  ...
                  <div class="card mask-custom">
                    <div class="card-body p-5 text-white">
                      ...
                      <div class="my-4">
                        ...
                        <h2 class="text-center mb-5">Edycja użytkownika</h2>
                        ...
                        <form method="post">
                          <!--nazwa -->
                            <div class="form-outline form-white mb-4">
                              <div class="form-outline form-white">
                                ...
                                <label class="form-label" for="form3Example1">Zmień nazwe</label>
                              </div>
                              <?php
                          ...
                          <div class="form-outline form-white mb-4">
                            ...
                            <label class="form-label" for="form3Example3">Zmień adres email</label>
                            <?php
                          ...
                          <div class="form-outline form-white mb-4">
                            ...
                            <label class="form-label" for="form3Example4">Zmień hasło</label>
                            <?php
                          ...
                          <button type="submit" class="btn btn-light btn-block mb-4">Zmień dane</button>
